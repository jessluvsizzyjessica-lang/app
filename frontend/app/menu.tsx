...
const styles = StyleSheet.create({
  ...
  nav: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: 20, borderBottomWidth: 1, borderBottomColor: "#1f2340" },
  ...
  mainCard: { borderRadius: 24, backgroundColor: "#141626", borderWidth: 1, borderColor: "#22264a", height: 380, justifyContent: "center" },
