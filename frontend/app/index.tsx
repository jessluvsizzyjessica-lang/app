...
import { ScrollView, View, Text, Image, Pressable, StyleSheet, useWindowDimensions, Linking } from "react-native";
      ...
      <View style={[styles.hero, isMobile && { flexDirection: "column" }]}>
        ...
        <View style={{ flex: 1, gap: 14 }}>
          <View style={styles.mainCard}>
            <Image source={require("../../assets/real/hero.jpg")} style={styles.mainImg} resizeMode="cover" />
            <View style={[styles.float, { top: 12, right: 12 }]}><Text style={styles.floatText}>NEXT EVENT • Marina — 02.14.26</Text></View>
            <View style={[styles.float, { bottom: 18, left: 12 }]}><Text style={styles.floatText}>🌸 Real floral garnishes • Riverside & Rowland Heights</Text></View>
          </View>
          <View style={{ flexDirection: "row", gap: 14 }}>
            <Image source={require("../../assets/real/mojito.jpg")} style={styles.small} resizeMode="cover" />
            <Image source={require("../../assets/real/menu.jpg")} style={styles.small} resizeMode="cover" />
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  float: { position: "absolute", backgroundColor: "rgba(20,22,38,0.92)", borderWidth: 1, borderColor: "#2a2f5a", borderRadius: 12, paddingHorizontal: 10, paddingVertical: 6 },
  floatText: { color: "#fff", fontSize: 10 },
  small: { flex: 1, height: 150, borderRadius: 16, borderWidth: 1, borderColor: "#22264a" },
